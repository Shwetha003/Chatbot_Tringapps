...
def parse_page_by_headings(html_content: str, is_wikipedia: bool = False) -> list:
    ...
    noise_selectors = [
        ...
        ".reference", ".reflist", ".language-list", "#p-lang", ".mw-editsection",
    ]
...
def run_heading_crawler(start_url: str) -> str:
...
async def scrape_to_pure_text(url: str) -> str:
    loop = asyncio.get_running_loop()
    with ThreadPoolExecutor(max_workers=1) as executor:
        return await loop.run_in_executor(executor, run_heading_crawler, url)